...
export default function UserDashboard() {
  ...
  const getNextMonday = (d = new Date()) => {
  ...
  useEffect(() => {
    if (bookingType === "week" && !selectedWeek) {
  ...
  const handleBookMeal = async (e) => {
    e.preventDefault();
    const now = new Date();
    const bookDate = new Date(bookingType === "single" ? date : selectedWeek);
            ...
            <div className="card-body">
              ...
              <form onSubmit={handleBookMeal}>
                ...
                {bookingType === "single" ? (
                  ...
                  <div className="mb-3">
                    <label htmlFor="selectedWeek" className="form-label">
