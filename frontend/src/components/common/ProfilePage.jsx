...
//           : "अवतार सफलतापूर्वक अपडेट किया गया!"
//       );
//     } catch (error) {
//       console.error("Error saving avatar:", error);
//       alert(
...
//           : "अवतार अपडेट करने में विफल। कृपया पुनः प्रयास करें।"
//       );
//     }
//   };
...
//         <div className="mt-8 grid grid-cols-3 gap-4 text-center">
//           <div>
//             <h3 className="text-lg font-semibold text-gray-700">{t.pan}</h3>
//             <p className="text-gray-600">{profileInfo.pan}</p>
//           </div>
//           <div>
...
//           </div>
//           <div>
//             <h3 className="text-lg font-semibold text-gray-700">{t.phone}</h3>
//             <p className="text-gray-600">{profileInfo.mobileNo}</p>
//           </div>
//         </div>
